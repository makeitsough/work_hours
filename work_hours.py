...
def start_d_hours(dt_in, dt_out):
	...
	# if out_biz >= in_biz:  #this is none type in the test. Has it not been initialized prior to calling the function? 
							#assuming start_day_hours < end_day_hours for now
	# else: 
	# 	start_day_hours = dt.timedelta(0)
